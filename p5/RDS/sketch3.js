...
class SkillebryterOgSeksjon {
    ...
    draw() {
        ...
        line(
            this.skillebryterOppX1,
            this.skillebryterOppY1,
            this.skillebryterOppX1,
            this.skillebryterTopp
        );
        line(
            this.skillebryterOppX2,
            this.lowerY1,
        ...
        line(
            this.skillebryterOppX1,
            this.skillebryterTopp,
            this.skillebryterStartX,
            this.skillebryterTopp
        );
        line(
            this.skillebryterSluttX,
            this.skillebryterTopp,
            this.skillebryterOppX2,
            this.skillebryterTopp
        );
        ...
        line(
            this.skillebryterSluttX,
            this.lastY2 - 1.5 * this.length + myDistY / 8,
            this.skillebryterSluttX,
            this.lowerY1 - 1.5 * this.length - myDistY / 8
        );
        line(
            this.skillebryterStartX,
            this.skillebryterTopp,
...
class StationLine {
    ...
    draw() {
        stroke("blue");
        line(
            this.x1 - (myDistX - myDistX / 3),
            this.connectionY2,
            this.x1 - (myDistX - myDistX / 6),
            this.y1
        ); // temp dist. and y2
        line(
            this.x1 - myDistX / 3,
